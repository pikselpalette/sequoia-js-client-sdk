...
class Registry {
  ...
  getService(serviceName) {
    console.warn('registry.getService is depracated. Please use registry.getServiceDescriptor instead.');
  ...
  getServiceDescriptor(serviceName) {
    ...
    return Promise.reject(new Error(`No service with name ${serviceName} exists`));
  }
  ...
  getServices(...serviceName) {
    console.warn('registry.getServices is deprecated. Please use registry.getServiceDescriptors instead.');
